...
np.save('./data/mini_data/Serial_Modes_MOS.npy', modes)
np.save('./data/mini_data/Serial_SingularValues.npy', svals)
end_time = time()
...
for iteration in range(niters):
    ...
    h5f = h5py.File('./data/mini_data/Batch_'+str(iteration)+'_data.h5', 'w')
